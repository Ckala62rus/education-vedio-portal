...
export default {
    ...
    methods: {
        createCategory(){
            ...
            axios.post('/admin/category-videos', this.form)
                .then(res => {
                    if (res.status === 201){
                        this.$notify({
                            title: "Создание категории видео",
                            text: "Категория видео создана!",
                            speed: 1000,
                            duration: 1000,
                            type: 'success'
                        });
