            ...
            <div class="col-md-12 mt-5 mb-5">
                <div class="alert alert-custom alert-white alert-shadow fade show gutter-b" role="alert">
                    ...
                    <div class="alert-text">
                        Редактирование категории для видео
                    </div>
                </div>
            </div>
                    ...
                    <form @submit.prevent="updateCategory">
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                />
                                <div class="invalid-feedback">{{errors.errorDescriptionText}}</div>
                            </div>
                        </div>
                        <div class="card-footer">
                            <button type="submit" class="btn btn-success mr-2">Обновить</button>
                            <Link :href="route('metronic.category-video.index')" as="button" method="get" class="btn btn-primary font-weight-bolder">Назад</Link>
                        </div>
                    </form>
                </div>
            </div>
...
export default {
    ...
    methods: {
        updateCategory(){
            ...
            axios.put('/admin/category-videos/' + this.id, this.form)
                .then(res => {
                    if (res.status === 200){
                        this.$notify({
                            title: "Категория видео обновлена!",
                            text: "Категория видео обновлена!",
                            speed: 3000,
                            duration: 3000,
                            type: 'success'
                        });
        ...
        getCategoryVideoById(){
            axios.get('/admin/category-videos/' + this.id)
                .then(res => {
